...
<div class="block box">
    ...
    <div class="block clearfix">
        ...
        <div class="AreaL" style="float: right;">
            <h3><span>最新登录系统5个用户</span></h3> 
            <div class="NewsList tc box_1" style="border-top: medium none;">
                <ul>
                    <?php if(is_array($logininfo)): $i = 0; $__LIST__ = $logininfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><?php echo ($v); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
