    ...
    <body>
            ...
            <div id="topNav" class="clearfix">
                <div style="float: left;"> 
                    <font id="ECS_MEMBERZONE"><div id="append_parent"></div>
                        欢迎光临本店&nbsp;
                        <?php if($_SESSION['user_name']!= ""): ?><span style='font-size:20px;font-weight:bold;'><?php echo (session('user_name')); ?></span>
                            <a href="/shop/index.php/Home/User/logout"> 退出</a>
                        <?php else: ?>
                            <a href="/shop/index.php/Home/User/login"> 登录</a>
                            <a href="/shop/index.php/Home/User/register">注册</a><?php endif; ?>
                    </font>
                </div>
        ...
        <div class="header_bg">
            ...
            <form id="searchForm" method="get" >
                ...
                <input name="imageField" value=" " class="go" style="cursor: pointer; background: url('/shop/Public/img/sousuo.gif') no-repeat scroll 0% 0% transparent; width: 39px; height: 20px; border: medium none; float: left; margin-right: 15px; vertical-align: middle;" type="submit">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="width:87%;">
                                    ...
                                    <span style="color:red;"><?php echo ($infoError['username']); ?></span>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td>
                                    ...
                                    <span style="color:red;"><?php echo ($infoError['password']); ?></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color:red;"><?php echo ($infoError['password2']); ?></span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color:red;"><?php echo ($infoError['user_email']); ?></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color:red;"><?php echo ($infoError['user_qq']); ?></span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color:red;"><?php echo ($infoError['user_tel']); ?></span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color:red;"><?php echo ($infoError['user_xueli']); ?></span>                            </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color:red;"><?php echo ($infoError['user_hobby']); ?></span>
                                </td>
                            </tr>
                            <tr>
