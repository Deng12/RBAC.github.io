        ...
        <table height="100%" cellspacing=0 cellpadding=0 width=170 
               ...
               <tr>
                <td valign=top align=middle>
                    ...
                    <?php if(is_array($auth_infoA)): $i = 0; $__LIST__ = $auth_infoA;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><table cellspacing=0 cellpadding=0 width=150 border=0>
                        <tr height=22>
                    ...
                    <table id="child<?php echo ($v['auth_id']); ?>" style="display: none" cellspacing=0 cellpadding=0  width=150 border=0>
                        <?php if(is_array($auth_infoB)): $i = 0; $__LIST__ = $auth_infoB;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i; if($vv['auth_pid'] == $v['auth_id']): ?><tr height=20>
                            ...
                            <td><a class=menuchild  href="/shop/index.php/Admin/<?php echo ($vv['auth_c']); ?>/<?php echo ($vv['auth_a']); ?>" target="right"><?php echo ($vv['auth_name']); ?></a></td>
